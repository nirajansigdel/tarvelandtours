...
<div class="content-wrapper">
    ...
    <section class="position-relative text-white text-center"
        ...
        <div class="container h-100 d-flex flex-column justify-content-center align-items-center position-relative">
            <div class="mt-5 pt-5">
                <h1 class="fw-bold display-4">Travel Posts</h1>
                <p class="mt-2 fs-5">
            ...
            <div class="row">
                <div class="col-12 text-center">
                    <div class="alert alert-info">
                        ...
                        <p>Please check back later for our latest travel stories and updates.</p>
                    </div>
                </div>
            </div>
        @else
                        ...
                        <div class="card h-100 shadow-sm">
                            @if(is_array($product->images) && count($product->images))
                                <img src="{{ asset('uploads/products/' . $product->images[0]) }}" class="card-img-top"
                                    alt="{{ $product->heading ?? 'Travel Post Image' }}" style="height: 200px; object-fit: cover;">
                            @else
        ...
        <div class="row mt-5">
            <div class="col-12">
                <div class="text-center text-muted">
                    <hr class="my-4">
                    <p class="mb-0">Discover amazing travel stories and insights from our adventures</p>
                </div>
            </div>
        </div>
