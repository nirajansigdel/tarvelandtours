...
<div class="content-wrapper">
    ...
    <section class="position-relative text-white text-center mb-5"
        ...
        <div class="container h-100 d-flex flex-column justify-content-center align-items-center position-relative">
            <div class="mt-5 pt-5">
                <h1 class="fw-bold display-4">{{ __('messages.Destination') }}</h1>
                <p class="mt-2 fs-5">
    ...
    <div class="container">
        <div class="row">
           <div class="directors-header mb-4 text-center">
            <h1 class="heading mb-1">{{ __('messages.beautiful_destination') }}</h1>
            <p class="extralarger">
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card h-100 shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="content-heading mt-2">{{ $product->getTranslated('heading') ?? 'Untitled Destination' }}</h5>
        ...
        <div class="row my-5">
            <div class="col-12">
                <div class="text-center text-muted">
                    ...
                    <p class="mb-0">{{ __('messages.discover_destinations') }}</p>
                </div>
            </div>
        </div>
    </div>
