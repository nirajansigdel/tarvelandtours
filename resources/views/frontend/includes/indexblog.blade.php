  ...
  <div class="container">
    <div class="row">
      <div class="text-center mb-4">
        ...
        <p class="xs-text">Timeless Adventures Await with Timeless Stories.</p>
      </div>
    </div>
    <div class="row">
        ...
        <div class="col-md-4 mb-4">
          <div class="blog-card reveal">
            ...
            <div class="blog-content">
              ...
              <a href="{{ route('SingleBlogpostcategory', $blogs->slug) }}" class="blog-cta">View details <span class="arrow">→</span></a>
            </div>
          </div>
        </div>
      @endforeach
