...
<div class="content-wrapper">
    ...
    <section class="position-relative text-white text-center"
        ...
        <div class="container h-100 d-flex flex-column justify-content-center align-items-center position-relative">
            <div class="mt-5 pt-5">
                <h1 class="fw-bold display-4">{{ __('messages.groupoffer') }}</h1>
                <p class="mt-2 fs-5">
                    <span class="fw-semibold">{{ __('messages.Home') }}</span>
                    <i class="fas fa-angle-double-right mx-2 text-warning"></i>
                  {{ __('messages.groupoffer') }}
                </p>
            </div>
        </div>
    </section>
    ...
    <div class="container my-4">
        <div class="row">
           <div class="directors-header mb-4 text-center mb-5">
            <h1 class="heading mb-1">{{ __('messages.group_offer') }}</h1>
            <p class="extralarger">
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card h-100 shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <h5 class="content-heading mt-2">{{ $product->getTranslated('heading') ?? 'Untitled Group Package' }}</h5>
