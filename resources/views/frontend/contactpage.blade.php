      ...
      <div class="row align-items-center g-4">
        ...
        <div class="col-md-7 text-center row">
          <div class="col-md-4 text-center bg-white rounded shadow-sm p-4 mb-2" data-aos="zoom-in">
            ...
            <h5 class="fw-semibold mb-2">{{ __('messages.office_address') }}</h5>
          ...
          <div class="col-md-4 text-center bg-white rounded shadow-sm p-4 mb-2" data-aos="zoom-in" data-aos-delay="100">
            ...
            <h5 class="fw-semibold mb-2">{{ __('messages.office_contact') }}</h5>
          ...
          <div class="col-md-4 text-center bg-white rounded shadow-sm p-4 mb-2" data-aos="zoom-in" data-aos-delay="200">
            ...
            <h5 class="fw-semibold mb-2">{{ __('messages.office_email') }}</h5>
    ...
    <div class="container">
      <div class="row gx-5 align-items-stretch rounded shadow">
        ...
        <div class="col-md-4 bg-orange  text-white p-4 rounded-start d-flex flex-column justify-content-center">
          <h4 class="fw-bold mb-4"> {{ __('messages.book_virtual_appointment') }}</h4>
          <ul class="list-unstyled">
            <li class="mb-3"><i class="fa-solid fa-circle-check me-2"></i> {{ __('messages.explore_tour_packages') }}</li>
            <li class="mb-3"><i class="fa-solid fa-circle-check me-2"></i> {{ __('messages.join_adventure_club') }}</li>
            <li class="mb-3"><i class="fa-solid fa-circle-check me-2"></i> {{ __('messages.travel_assistance') }}</li>
            <li class="mb-3"><i class="fa-solid fa-circle-check me-2"></i> {{ __('messages.travel_internship_programs') }}
            </li>
            <li><i class="fa-solid fa-circle-check me-2"></i> {{ __('messages.sustainable_travel') }}</li>
        ...
        <div class="col-md-8 bg-white p-4 rounded-end">
          <form id="contactForm" method="POST" action="{{ route('Contact.store') }}">
            ...
            <div class="row g-3">
              <div class="col-md-6">
                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="{{ __('messages.Name') }}"
              ...
              <div class="col-md-6">
                <input type="tel" name="phone_no" class="form-control @error('phone_no') is-invalid @enderror"
                  placeholder="{{ __('messages.Phone_Number') }}" id="phoneInput" required>
                @error('phone_no')
                  <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              </div>
              <div class="col-md-6">
                <input type="text" name="service" class="form-control @error('service') is-invalid @enderror"
                  placeholder="{{ __('messages.interested_service') }}" value="{{ old('service') }}">
                @error('service')
                  <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              </div>
              ...
              <div class="col-12">
                <button type="submit" class="btn cta-button px-4 py-3 rounded shadow">{{ __('messages.Booknow') }}</button>
              </div>
            </div>
